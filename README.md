...
Once in the Jupyter Notebook, please enter the folder "Notebook_run" and run the script (**CBEB_2020_2.ipynb**). You will observe the outputs after clicking the "Run interact" buttons. You can modify the values of the widgets to observe other scenarios interesting for you.
